...
CC Switch は **[Code Go 公式サイト](https://shu26.cfd)**、**[Code Go ダウンロードページ](https://shu26.cfd/download)**、またはプロジェクトのソースリポジトリからのみ入手してください。支払い、チャージ、ログイン情報の入力を求める「CC Switch」サイトやクライアントは公式ではありません。
...
1. [Code Go ダウンロードページ](https://shu26.cfd/download) にアクセス
