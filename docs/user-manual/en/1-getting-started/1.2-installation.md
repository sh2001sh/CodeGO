...
Only download CC Switch from **[Code Go official website](https://shu26.cfd)**, **[Code Go download page](https://shu26.cfd/download)**, or the project source repository. Any "CC Switch" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Code Go download page](https://shu26.cfd/download)
