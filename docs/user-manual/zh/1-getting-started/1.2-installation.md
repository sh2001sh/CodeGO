...
请只从 **[Code Go 官网](https://shu26.cfd)**、**[Code Go 下载页](https://shu26.cfd/download)** 或项目源码仓库获取 CC Switch。任何要求付费、充值或索取登录凭据的“CC Switch”网站或客户端都不是官方渠道。
...
1. 访问 [Code Go 下载页](https://shu26.cfd/download)
