...
Security fixes are released as patch versions and announced through the [Code Go download page](https://shu26.cfd/download). We recommend always updating to the latest version.

安全修复通过补丁版本发布，并通过 [Code Go 下载页](https://shu26.cfd/download) 通知。建议始终更新到最新版本。
