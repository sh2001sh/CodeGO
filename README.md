...
Download the latest `CodeGo_{version}_x64_en-US.msi` installer or `CodeGo_{version}_x64_portable.zip` portable build from the [Code Go download page](https://shu26.cfd/download).

### macOS Users

Download `CodeGo_{version}_universal.dmg` (recommended) or `CodeGo_{version}_universal.zip` from the [Code Go download page](https://shu26.cfd/download).

> **Note**: `CodeGo_{version}_universal.app.tar.gz` is reserved for the in-app updater channel, not for manual installation.

### Arch Linux Users

Download the Linux build that matches your architecture from the [Code Go download page](https://shu26.cfd/download). On Arch-based systems, the AppImage is the lowest-friction option unless you maintain your own package recipe.

### Linux Users

Download the latest Linux build from the [Code Go download page](https://shu26.cfd/download):
...
> **Flatpak**: Not included in the official Code Go release channel. You can build it yourself from the `.deb` — see [`flatpak/README.md`](flatpak/README.md) for instructions.
