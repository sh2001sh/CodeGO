...
export function useSettingsForm(): UseSettingsFormResult {
  ...
  useEffect(() => {
    ...
    const normalized: SettingsFormState = {
      ...
      codegoTelemetryEnabled: data.codegoTelemetryEnabled ?? false,
    ...
    (serverData: Settings | null) => {
      ...
      const normalized: SettingsFormState = {
        ...
        codegoLowBalanceThresholdUsd:
          serverData.codegoLowBalanceThresholdUsd ?? 10,
        codegoTelemetryEnabled: serverData.codegoTelemetryEnabled ?? false,
